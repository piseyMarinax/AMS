	...
	<div class="col-md-12">
		<div class="portlet light portlet-fit portlet-form bordered">
			...
			<div class="portlet-body">
				<form class="form-horizontal" role="form" method="POST" action="{{ url('supplier/update') }}">
					{{ csrf_field() }}
					<input id="id" type="hidden" name="id" value="{{$data->id}}"/>
					<input id="old_sup_code" type="hidden" name="old_sup_code" value="{{$data->sup_code}}"/>
					<div class="form-body">
						<div class="row">
							<div class="col-md-6">
								<div class="form-group{{ $errors->has('sup_code') ? ' has-error' : '' }}">
									...
									<div class="col-md-8">
										<input id="sup_code" type="text" class="form-control" name="sup_code" value="{{ $data->sup_code }}" autofocus>
								...
								<div class="form-group{{ $errors->has('sup_name') ? ' has-error' : '' }}">
									...
									<div class="col-md-8">
										<input id="sup_name" type="text" class="form-control" name="sup_name" value="{{ $data->sup_name }}">
