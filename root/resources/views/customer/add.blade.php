						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group{{ $errors->has('cus_code') ? ' has-error' : '' }}">
									...
									<div class="col-md-8">
										<input id="cus_code" type="text" class="form-control" name="cus_code" value="{{ old('cus_code') }}" autofocus>
							...
							<div class="col-md-6">
								...
								<div class="form-group{{ $errors->has('cont_vatin') ? ' has-error' : '' }}">
									<label for="cont_vatin" class="col-md-4 control-label"><strong>{{ trans('template.vatin') }}</strong>
										
									</label>
									<div class="col-md-8">
										<input id="cont_vatin" type="text" class="form-control" name="cont_vatin" value="{{ old('cont_vatin') }}">
										@if ($errors->has('cont_vatin'))
											<span class="help-block">
												<strong>{{ $errors->first('cont_vatin') }}</strong>
											</span>
										@endif
									</div>
								</div>
