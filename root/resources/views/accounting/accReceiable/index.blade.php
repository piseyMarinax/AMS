...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<span>{{ trans('template.account_receivable') }}</span>
		</li>
	</ul>
</div>
<br/>
		...
		<div class="portlet light bordered">			
			<div class="portlet-title">
				<div class="caption font-green">
					...
					<span class="caption-subject bold uppercase">{{ trans('template.account_receivable') }}</span>
				</div>
				<div class="actions">
					<a title="{{ trans('template.add_new') }}" class="btn btn-circle btn-icon-only btn-default" href="{{ url('accounting/account_receivable/add') }}">
			...
			<div class="portlet-body">
				...
				@endif
				<table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="table-income">
					<thead>
						<tr class="bg-primary">
