	...
	<div class="col-md-12">
		<div class="portlet light portlet-fit portlet-form bordered">
			...
			<div class="portlet-body form-body">
				<form class="form-horizontal formjournal_entry" method="POST" action="{{url('accounting/journal_entry/insert')}}" id="form_validation">
					...
					<div class="form-body">
						...
						<div style="border: 1px solid #b7b7b7; background: rgba(173, 203, 206, 0.28);    margin-top: -15px;" class="col-md-6">
							...
							<div class="form-group{{ $errors->has('journal_entry_date') ? ' has-error' : '' }}  margin-top-20" style="padding: 8.5px;">
								...
								<div class="col-md-9">
									<div class="input-icon right">
										<input class="form-control datepicker" type="text" name="journal_entry_date" id="journal_entry_date" placeholder="{{trans('template.date')}} - day-Month-Year" >
									</div>
						...
						<table class="table table-striped table-bordered table-hover dt-responsive" id="tablejournal_entry" width="100%" >
							...
							<tbody>
								<tr>
									...
									<td>
										<input type="text" class="form-control enter_debit enter_debit0" onkeyup="EnterDebit(this,0)" name="debit[]" placeholder="{{trans('template.amount')}}">
									</td>
									<td>
										<input type="text" class="form-control enter_credit enter_credit0" onkeyup="EnterCredit(this,0)" name="credit[]" placeholder="{{trans('template.amount')}}">
									</td>
									<td>
					...
					<div class="form-actions">
						<div class="row">
							<div class="col-md-offset-4 col-md-6">
								...
								<a href="{{url('journal_entry/index')}}"><button type="button" id="btnClose" class="btn btn-danger"> <i class="fa fa-times-circle"> </i> <strong> {{trans('template.cancel')}}</strong></button> </a>
							</div>
						</div>
					</div>
				</form>
