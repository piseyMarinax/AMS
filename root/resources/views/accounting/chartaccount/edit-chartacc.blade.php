	...
	<div class="col-md-12">
		<div class="portlet light portlet-fit portlet-form bordered">
			...
			<div class="portlet-body form-body">
				<form class="form-horizontal" method="POST" action="{{url('/accounting/chart_account/chart_accounting/update')}}" id="form_validation">
					...
					<div class="form-body">
						...
						<div class="form-group{{ $errors->has('code') ? ' has-error' : '' }}  margin-top-20">
							...
							<div class="col-md-6">
								<div class="input-icon right">
									<i class="fa"></i>
									<input type="text" class="form-control" value="{{$edit->ac_code}}" name="code" id="code" /> </div>
									@if($errors->has('code'))
						...
						<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}  margin-top-20">
							...
							<div class="col-md-6">
								<div class="input-icon right">
									<i class="fa"></i>
									<input type="text" class="form-control" value="{{$edit->ac_name}}" name="name" id="name" /> </div>
									@if($errors->has('name'))
							...
							<div class="col-md-6">
								<div class="input-icon right">
									<select name="account_type" class="form-control select2">
										...
										{{\App\Helpers\Helpers::getChartAccount($edit->ac_type)}}
									</select>
								</div>
							...
							<div class="col-md-6">
								<div class="input-icon right">
									<select name="parent_id" class="form-control select2">
										<option value="0">--- {{trans('template.please_select')}} ---</option>
										{{\App\Helpers\Helpers::getChartAccounting($edit->parent_id)}}
									</select>
								</div>
						...
						<div class="form-group{{ $errors->has('ordering') ? ' has-error' : '' }}  margin-top-20">
							...
							<div class="col-md-6">
								<div class="input-icon right">
									<i class="fa"></i>
									<input type="text" class="form-control" value="{{$edit->ordering}}" name="ordering" id="ordering" /> </div>
						...
						<div class="form-group{{ $errors->has('trash') ? ' has-error' : '' }}  margin-top-20">
							...
							<div class="col-md-6">
								<div class="input-icon right">
									<i class="fa"></i>
									<input type="text" class="form-control" value="{{$edit->no_trash}}" name="trash" id="trash" /> </div>
									@if($errors->has('trash'))
