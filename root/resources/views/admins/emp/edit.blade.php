	...
	<div class="col-md-12">
		<div class="portlet box blue">
			...
			<div class="portlet-body">
				<form class="form-horizontal" role="form" method="POST" action="{{ url('admins/staff/updateSave') }}" enctype="multipart/form-data">
					{{ csrf_field() }}
					<div class="form-body">
						@if(count($errors))
						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="form-group{{ $errors->has('idcard') ? ' has-error' : '' }}">
									...
									<div class="col-md-8">
										...
										<input id="idcard" type="text" class="form-control" name="idcard" value="{{$edit->idnumber}}" autofocus>
								...
								<div class="form-group{{ $errors->has('namekh') ? ' has-error' : '' }}">
									...
									<div class="col-md-8">
										<input id="namekh" type="text" class="form-control" name="namekh" value="{{$edit->fullnamekh}}">
								...
								<div class="form-group{{ $errors->has('nameen') ? ' has-error' : '' }}">
									...
									<div class="col-md-8">
										<input id="nameen" type="text" class="form-control" name="nameen" value="{{$edit->fullnameen}}">
								...
								<div class="form-group{{ $errors->has('sdob') ? ' has-error' : '' }}">
									...
									<div class="col-md-8">
										...
										if(!empty($dob)){
										?>
											<input class="form-control datepicker" type="text" name="sdob" id="sdob" placeholder="{{trans('template.date')}}:  dd-mm-yyyy" value="<?php echo date('d-M-Y', strtotime($dob));?>">
										<?php
										}else{?>
								...
								<div class="form-group{{ $errors->has('sregisterdate') ? ' has-error' : '' }}">
									...
									<div class="col-md-8">
										<div class="input-icon right">
										<?php $register = $edit->sdateregister;
										if(!empty($register)){?>
											<input class="form-control datepicker" type="text" name="sregisterdate" id="sregisterdate" placeholder="{{trans('template.date')}}:  dd-mm-yyyy" value="<?php echo date('d-M-Y', strtotime($register));?>">
										<?php
										}else{?>
								...
								<div class="form-group{{ $errors->has('sresigndate') ? ' has-error' : '' }}">
									...
									<div class="col-md-8">
										<div class="input-icon right">
										<?php $resign = $edit->sdateleave;
										if(!empty($resign)){?>
											<input class="form-control datepicker" type="text" name="sresigndate" id="sresigndate" placeholder="{{trans('template.date')}} - day-Month-Year" value="<?php echo date('d-m-Y', strtotime($resign));?>">
										<?php
										}else{?>
								...
								<div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
									...
									<div class="col-md-8">
										<input id="phone" type="text" class="form-control" name="phone" value="{{ $edit->phone }}">
										@if ($errors->has('phone'))
											<span class="help-block">
								...
								<div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
									...
									<div class="col-md-8">
										<input id="email" type="email" class="form-control" name="email" value="{{ $edit->semail }}">
										@if ($errors->has('email'))
											<span class="help-block">
							...
							<div class="col-md-6">
								...
								<div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
									...
									<?php 
										$status=array(
											...
											'2' => trans("template.disable"),
										);
										$status=array_merge($status);
									?>
									<div class="col-md-8">
										<select name="status" id="status" class="form-control">
		                                    <?php $status = $edit->sstatus;?>
								...
								<div class="form-group{{ $errors->has('stype') ? ' has-error' : '' }}">
									...
									<div class="col-md-8">
										<select name="stype" id="stype" class="form-control">
		                                    <?php $stype = $edit->stafftypeid;?>
		                                        <option value="1" <?=$stype==1?'selected':''?>> Office </option>
		                                        <option value="2" <?=$stype==2?'selected':''?>> Security </option>
		                                    </select>
										@if ($errors->has('stype'))
											<span class="help-block">
								...
								<div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
									...
									<div class="col-md-8">
										<textarea id="address" class="form-control" name="address" cols="5">{{$edit->saddress}}</textarea>
						...
						<div class="row">
                            <div class="col-md-12">
                            	<div class="form-group{{ $errors->has('detail') ? ' has-error' : '' }}">
									...
									<div class="col-md-12">
										<textarea id="detail" class="form-control" name="detail" cols="10" rows="5">{{$edit->sdetail}}</textarea>
					...
					<div class="form-actions">
						<div class="row">
							<div class="col-md-offset-4 col-md-8">
								<button type="submit" name="save" value="s" class="btn btn-primary"> <i class="fa fa-pencil"> </i> <strong>{{ trans('template.save_change') }}</strong></button>
