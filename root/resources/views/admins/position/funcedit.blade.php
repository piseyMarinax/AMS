...
@section('content')
 <div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="{{url('/admins/position/index')}}">{{ trans('template.function') }}</a>
			<i class="fa fa-circle"></i>
		</li>
		<li>
	...
	<div class="col-md-12">
		<div class="portlet light portlet-fit portlet-form bordered">
			...
			<div class="portlet-body form-body">
				<form class="form-horizontal" method="POST" action="{{url('/admins/position/update')}}" id="form_validation">
					...
					<div class="form-body">
						...
						<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}  margin-top-20">
							...
							<div class="col-md-6">
								<div class="input-icon right">
									<i class="fa"></i>
									<input type="text" class="form-control" value="{{$edit->functitle}}" name="name" id="name" /> </div>
									@if($errors->has('name'))
						...
						<div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}  margin-top-20">
							...
							<div class="col-md-6">
								<div class="input-icon right">
									<i class="fa"></i>
									<input type="text" value="{{$edit->funcdetail}}" class="form-control" name="des" id="description" /> </div>
