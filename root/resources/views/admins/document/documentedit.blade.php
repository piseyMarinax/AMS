...
@section('content')
 <div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="{{url('/admins/dept/index')}}">{{ trans('template.document') }}</a>
			<i class="fa fa-circle"></i>
		</li>
		<li>
	...
	<div class="col-md-12">
		<div class="portlet light portlet-fit portlet-form bordered">
			...
			<div class="portlet-body form-body">
				<form class="form-horizontal" method="POST" action="{{url('/admins/document/update')}}" id="form_validation">
					...
					<div class="form-body">
						...
						<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}  margin-top-20">
							...
							<div class="col-md-6">
								<div class="input-icon right">
									<i class="fa"></i>
									<input type="text" class="form-control" value="{{$edit->docname}}" name="name" id="name" /> </div>
									@if($errors->has('name'))
						...
						<div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}  margin-top-20">
							...
							<div class="col-md-6">
								<div class="input-icon right">
									<i class="fa"></i>
									<input type="text" value="{{$edit->docdetail}}" class="form-control" name="des" id="description" /> </div>
