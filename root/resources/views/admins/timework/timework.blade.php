	...
	<div class="col-md-12">
		<div class="portlet light portlet-fit portlet-form bordered">
			...
			<div class="portlet-body form-body">
				<form class="form-horizontal" method="POST" action="{{url('/admins/timework/insert')}}" id="form_validation">
					...
					<div class="form-body">
						...
						<div class="form-group{{ $errors->has('time') ? ' has-error' : '' }}  margin-top-20">
							...
							<div class="col-md-6">
								<div class="input-icon right">
									<i class="fa"></i>
									<input type="text" class="form-control" value="{{ old('time') }}" name="time" id="time" placeholder="8:00 AM - 5:00 PM" /> </div>
									@if($errors->has('time'))
