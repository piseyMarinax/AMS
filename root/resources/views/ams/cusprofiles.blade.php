            ...
            <div class="col-md-12">
                <div class="portlet box blue">
                    <div class="portlet-title" style="font-family: Hanuman;">
                        ...
                        <div class="tools">
                        <a style="color:#fff;" href="{{url('backend/customers/cusedit')}}<?php echo '/'.$pro->id; ?>?ref=updateprofile">
                                <i class="font-white fa fa-edit"></i> {{ trans("template.edit") }} </a>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group{{ $errors->has('idcard') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <input id="cusid" type="text" class="form-control" name="cusid" value="<?php echo 'AMS-000'?>{{$pro->cust_id}}" readonly>
                                                @if ($errors->has('cusid'))
                                        ...
                                        <div class="form-group{{ $errors->has('nameen') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-8">
                                                <input id="nameen" type="text" class="form-control" name="nameen" value="{{$pro->cust_name}}" readonly>
                                        ...
                                        <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-8">
                                                <input id="phone" type="text" class="form-control" name="phone" value="{{$pro->cust_phone}}" readonly>
                                                @if ($errors->has('phone'))
                                                    <span class="help-block">
                                        ...
                                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-8">
                                                <input id="email" type="email" class="form-control" name="email" value="{{$pro->cust_email}}" readonly>
                                                @if ($errors->has('email'))
                                                    <span class="help-block">
                                        ...
                                        <div class="form-group{{ $errors->has('namekh') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-8">
                                                <input id="namekh" type="text" class="form-control" name="namekh" value="{{$pro->cust_comname}}" readonly>
                                        ...
                                        <div class="form-group{{ $errors->has('items') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-8">
                                                <input id="items" type="text" class="form-control" name="items" value="<?php echo $cval->items;?>" readonly>
                                                @if ($errors->has('items'))
                                                    <span class="help-block">
                                        ...
                                        <div class="form-group{{ $errors->has('items') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-8">
                                                <input id="items" type="text" class="form-control" name="items" value="" readonly>
                                                @if ($errors->has('items'))
                                                    <span class="help-block">
                                                        <strong>{{ $errors->first('items') }}</strong>
                                                    </span>
                                        ...
                                        <div class="form-group{{ $errors->has('iprice') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-8">
                                                <input id="iprice" type="text" class="form-control" name="iprice" value="{{ old('iprice') }}" readonly>
                                                @if ($errors->has('iprice'))
                                                    <span class="help-block">
                                                        <strong>{{ $errors->first('iprice') }}</strong>
                                                    </span>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('sdob') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-icon right">
                                                    <input class="form-control" type="text" name="reg_date" id="reg_date" placeholder="{{trans('template.date')}}:  dd-mm-yyyy" value="<?php echo date('M d, Y', strtotime($d));?>" readonly>
                                                </div>
                                        ...
                                        <div class="form-group{{ $errors->has('reffile') ? ' has-error' : '' }}">
                                            ...
                                            <label for="file" class="col-md-8" style="font-family: Hanuman; margin-top: 5px;"><strong><a href="{{url('public/media/')}}/<?php echo $dval->c_files;?>" title="<?php echo @$dval->c_files;?>" target="_blank">{{ trans('template.file') }} <?php echo @$cd;?></a></strong>
                                            </label>
                                        </div>
                                        <?php
                                        }
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-4 col-md-8" style="font-family: KhmerOS;">
                                        <a href="{{ url('/backend/customers/creceiptmonth') }}/<?php echo $pro->id;?>" class="btn btn-success btn-outline"> <i class="fa fa-file-text-o"> </i> <strong>{{ trans('template.invoice') }}</strong></a>
                                        <a href="{{ url('/backend/customers/creceiptmonth') }}/<?php echo $pro->id;?>" class="btn btn-success btn-outline" target="_blank"> <i class="fa fa-file-text-o"> </i> <strong>{{ trans('template.receipt') }}</strong></a>
                                    </div>
                                </div>
                            </div>
                        </form>
