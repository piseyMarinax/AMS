...
class CreateTablePayApDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('table_pay_ap_details', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('table_pay_ap_details');
    }
}
